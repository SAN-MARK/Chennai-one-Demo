          ...
          <div className="space-y-3.5">
            <div className="bg-slate-950 p-3 rounded-xl border border-slate-850/80 text-xs">
              <div className="flex justify-between items-center">
                <span className="text-slate-500 font-mono">ID CLASS</span>
                <span className="text-slate-300 font-bold">{idVerification.idType}</span>
              </div>
            ...
            <form onSubmit={submitNewID} className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 px-4 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-amber-500"
                  required
                />
              </div>
            ...
            <div className="space-y-2">
              {operatorVerifications.map((audit, idx) => (
                <div key={idx} className="bg-slate-950 border border-slate-900 p-3 rounded-xl space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-1 text-[9px] bg-slate-900 p-1.5 rounded font-mono">
                    <div className="text-slate-500">Document Link:</div>
                    <div className="text-slate-300 text-right underline cursor-pointer">{audit.DocumentLink}</div>
