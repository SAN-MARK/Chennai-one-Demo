          ...
          filteredHistory.map((txn) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200">{txn.type} <span className="font-mono font-medium">(₹{txn.amount})</span></h4>
              ...
              <div className="text-right flex items-center gap-1.5">
                <div>
                  ...
                  <p className="text-[9px] text-slate-500 mt-1 font-mono">{txn.timestamp.split(' ')[0]}</p>
                </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-[340px] overflow-hidden shadow-2xl animate-[scaleIn_0.2s_ease]">
            ...
            <div className="p-5 space-y-4 text-xs">
              <div className="text-center py-3">
                ...
                <h3 className="text-3xl font-bold text-amber-400 mt-1 font-mono">₹{selectedTxn.amount}.00</h3>
