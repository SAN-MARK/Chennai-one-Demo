        ...
        <form onSubmit={handlePurchase} className="space-y-4">
          ...
          <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 flex justify-between items-center mt-6">
            ...
            <div className="text-right">
              <span className="text-2xl font-bold text-amber-400 font-mono">₹{calculateFare()}</span>
            </div>
          </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3.5 pt-1 text-xs border-t border-b border-slate-100 py-3.5">
                ...
                <div>
                  ...
                  <span className="text-base font-bold text-blue-800 leading-none font-mono">₹{purchasedTicket.fare}.00</span>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="text-center mb-5 w-full">
                <div className="flex items-center justify-center gap-1.5 text-blue-900 font-display font-bold text-sm uppercase tracking-wider mb-1">
              ...
              <div className="w-full mt-5 space-y-2 text-xs border-t border-slate-100 pt-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-emerald-600 font-bold text-sm font-mono">₹{purchasedTicket.fare}.00</span>
                </div>
                <div className="flex justify-between">
